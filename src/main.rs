...
const DESCRIBE: &str = r#"{
  ...
  "provenance_limitations": [
      ...
      "MEASURED 2026-08-12 against the upstream goldens: cut_rows 10 of 10 comparable cases exact (DEF ROW diff); endcap + tapcell placement 9 of 9 cases exact, every physical cell matching in master, position and orientation. Instance NAMES match except the trailing counter, which follows the vertex order Boost returns per polygon -- an arbitrary starting vertex rather than a stated rule.",
      ...
      "MEASURED 2026-08-12 against the upstream goldens at the pin: cut_rows 10 of 10, endcaps + tapcells 9 of 9, and the combined tapcell 16 of 16 -- comparing every physical cell (name, master, position, orientation) and the DEF ROW lines. The largest case places 22844 cells. Instance NAMES match except the trailing counter, which follows the vertex order Boost returns per polygon: an arbitrary starting vertex rather than a stated rule.",
      ...
      "Written against the upstream tap regression goldens at pin b5624809f29048e1f9ce9e83eb562620c652e084, where all 38 cases reproduce. Conformance for the implemented subset is measured by diffing the DEF ROWS section against the case's .defok: 10 of 10 comparable cases exact.",
